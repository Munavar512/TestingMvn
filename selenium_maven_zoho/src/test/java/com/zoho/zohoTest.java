...
public class zohoTest {
	...
	String path = "/Users/mina/Selenium/testing-maven/selenium_maven_zoho/src/test/resources/config.properties";
	String excelPath="‎⁨/selenium_maven_zoho/src/test/resources/data.xlsx";
	Properties prop;
	...
	public void setUp() throws IOException {
		...
		FileInputStream ip = new FileInputStream(path);   //configuration file setup 
		prop = new Properties();
		prop.load(ip);
	...
	public void printExcel() {
		...
		List<WebElement> columns = driver.findElements(By.cssSelector("#reportTab>tbody>tr td"));
